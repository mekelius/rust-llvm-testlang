...
impl<'ctx> CodeGen<'ctx> {
    pub fn handle_number_literal(&self, value: &str) -> AnyValueEnum<'_> {
        self.context
            .i64_type()
    ...
    pub fn handle_string_literal(&self, value: &str) -> AnyValueEnum<'_> {
        self.builder
    ...
    pub fn handle_boolean_literal(&self, value: &bool) -> AnyValueEnum<'_> {
        self.context
            .bool_type()
